...
import { BrowserRouter as Router, Link, useNavigate } from "react-router-dom"; // Use useNavigate instead of useHistory
...
const MobileSearch = () => {
  ...
  const searchWebsite = () => {
    ...
    if (path) {
      navigate(path); // Using navigate instead of history.push
    }
  };
        ...
        <div className="mobile-search">
          ...
          <div className="mobile-search-select">
            <div className="mobile-search-options">
              {options.map((option) => (
                <div className="mobile-search-option" type="button" key={option.value}>
                  <span>
                    <span>
                    ...
                    <FontAwesomeIcon
                      ...
                      title="Clear"
                      onClick={(e) =>
                        removeOption(e.currentTarget.parentElement.parentElement)
                      }
                    />
                  </span>
                </div>
